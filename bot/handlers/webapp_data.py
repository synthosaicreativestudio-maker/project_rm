    ...
    try:
        ...
        if action_type == 'text':
            ...
            if img_bytes:
                ...
                photo_file = BufferedInputFile(img_bytes, filename="generated_image.png")
                await message.answer_photo(photo=photo_file, caption=f"✨ Generated by {model_id}")
            else:
                await message.answer("❌ Не удалось сгенерировать изображение.", parse_mode=None)
